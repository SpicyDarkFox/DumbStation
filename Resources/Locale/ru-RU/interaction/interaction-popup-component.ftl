...
petting-failure-pibble = Вы протягиваете руку, чтобы погладить { THE($target) }, но { SUBJECT($target) } бросается на вас!
...
petting-success-batonbot = Вы гладите { THE($target) } по { POSS-ADJ($target) } защитной металлической голове.
petting-success-disablerbot = Вы гладите { THE($target) } по { POSS-ADJ($target) } защитной металлической голове.
petting-success-minebot = Вы гладите { THE($target) } по { POSS-ADJ($target) } закалённой металлической голове.
petting-success-fillbot = Вы гладите { THE($target) } по { POSS-ADJ($target) } исполнительной металлической голове.
petting-success-plantbot = Вы гладите { THE($target) } по { POSS-ADJ($target) } испачканной грязью металлической голове.
petting-success-weldbot = Вы гладите { THE($target) } по { POSS-ADJ($target) } покрытой пятнами металлической голове.
...
petting-failure-gladiabot = Вы протягиваете руку, чтобы погладить { THE($target) }, но { SUBJECT($target) } хочет только сражаться!
petting-failure-batonbot = Вы протягиваете руку, чтобы погладить { THE($target) }, но { SUBJECT($target) } чуть не тычет в вас своим батоном!
...
petting-failure-plantbot = Вы протягиваете руку, чтобы погладить { THE($target) }, но кусачки { POSS-ADJ($target) } чуть не отхватывают вам пальцы!
petting-failure-weldbot = Вы протягиваете руку, чтобы погладить { THE($target) }, но сварка { POSS-ADJ($target) } чуть не обжигает вам руку!
...
petting-success-magmahand = Каким-то чудом вам удаётся погладить { THE($target) } по { POSS-ADJ($target) } раскалённой поверхности.
petting-failure-magmahand = Вы протягиваете руку, чтобы погладить { THE($target) }, но { POSS-ADJ($target) } обжигающе горячая поверхность заставляет вас передумать.
