...
injector-spent-text = Использовано
...
onetime-injector-simple-volume-label =
    Объём: [color=white]{ $currentVolume }[/color]
...
injector-component-injecting-locked-text = Заблокировано на введение
...
injector-component-deny-chitinid = Экзоскелет { $target } слишком толстый, чтобы игла могла его проткнуть.
