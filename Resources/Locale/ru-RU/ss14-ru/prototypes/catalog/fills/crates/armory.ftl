...
ent-CrateArmoryBRDIR25 = ящик BRDI-R25
    .desc = Содержит две булпап-винтовки со встроенным глушителем. Импортировано из Biesel Republic Defense Industries. Для открытия требуется доступ к оружейной.
