...
ent-CratePlasmaInternals = ящик дыхательных систем (плазма)
    .desc = Содержит четыре дыхательные маски и четыре баллона плазмы. Предназначено для плазмалюдов.
ent-CratePlasmamanEnvirosuit = ящик защитных костюмов плазмалюдов
    .desc = Содержит два полных комплекта защитных костюмов, две дыхательные маски и два баллона плазмы. Предназначено для плазмалюдов.
