...
ent-MechMaulerSyndie = Маулер
    .desc = Модифицированный «Мародер», используемый Синдикатом; он не так маневренен, как «Темный Гигакс», но компенсирует это броней и чистой огневой мощью. На задней части бронепластины имеется надпись «Cybersun Inc.».
