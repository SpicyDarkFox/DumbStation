...
gun-burst-fire-rate-examine = Скорострельность очередью: [color={ $color }]{ $fireRate }[/color] выстр/мин.
gun-burst-fire-burst-count =
    { $burstcount ->
        [one] Можно установить стрельбу очередями по [color={ $color }]{ $burstcount }[/color] выстрелу.
        [few] Можно установить стрельбу очередями по [color={ $color }]{ $burstcount }[/color] выстрела.
       *[other] Можно установить стрельбу очередями по [color={ $color }]{ $burstcount }[/color] выстрелов.
    }
gun-damage-modifier-examine = Множитель урона при выстреле: [color={ $color }]x{ $damage }[/color].
