...
time-transfer-panel-warning-group-no-time = Время группы пустое
...
time-transfer-panel-warning-transfer-process = Перенос времени в процессе...
...
cmd-timetransferpanel-desc = Открыть меню переноса времени
