...
signal-port-name-material-silo-utilizer = Утилизатор хранилища материалов
signal-port-description-material-silo-utilizer = Порт взаимодействия с шахтным хранилищем материалов станции
signal-port-name-fill-any-item = Цель Филлбота
signal-port-description-fill-any-item = Целевой порт для вставки предметов Филлботом
