...
reagent-desc-cryanobalamin = Ранее популярная добавка к энергетическим напиткам для восстановления выносливости, ныне запрещённая к коммерческому использованию из-за канцерогенных свойств.
reagent-name-liftloversspecial = спецкоктейль «качок»
reagent-desc-liftloversspecial = Химический коктейль, быстро восстанавливающий выносливость. Несмотря на официальный запрет, остаётся популярным на чёрном рынке напитком среди фанатов фитнеса. Канцерогенен в больших дозах.
reagent-name-morphine = морфин
reagent-desc-morphine = Мощный анальгетик, позволяющий пациенту безболезненно переносить хирургические операции даже в сознании. Вызывает сильное привыкание при злоупотреблении. Передозировка может вызвать затруднение дыхания.
