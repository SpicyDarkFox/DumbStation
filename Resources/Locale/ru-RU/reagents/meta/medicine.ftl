...
reagent-desc-artiplates = Высокотехнологичная форма искусственной крови, которая быстро расширяется при попадании в кровоток. Из-за своих свойств расширения в больших дозах может вызвать сильное внутреннее кровотечение.
reagent-name-enunciase = энунциаза
reagent-desc-enunciase = Фермент, стимулирующий речевые центры мозга, устраняющий заикание от других препаратов и временно навязывающий «идеальную» речь. В больших дозах вызывает тошноту.
