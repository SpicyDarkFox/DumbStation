...
role-timer-age-to-old = Возраст вашего персонажа должен быть не более [color=yellow]{ $age }[/color] лет для этой роли.
role-timer-age-to-young = Возраст вашего персонажа должен быть не менее [color=yellow]{ $age }[/color] лет для этой роли.
