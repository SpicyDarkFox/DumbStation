...
steal-target-groups-captain-weapon = оружие капитана
steal-target-groups-corporate-liaison-weapon = оружие представителя nanotrasen
steal-target-groups-jetpack-captain-filled = джетпак капитана
steal-target-groups-weapon-head-of-security-weapon = оружие главы службы безопасности
