...
public sealed class GhostBarSystem : EntitySystem
{
    ...
    public void SpawnPlayer(GhostBarSpawnEvent msg, EntitySessionEventArgs args)
    {
        ...
        var mobUid = _spawningSystem.SpawnPlayerMob(randomSpawnPoint, randomJob, profile, null, sponsorTier: SponsorSimpleManager.GetTier(player.UserId), uuid: player.UserId.ToString());   //LP edit
