    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
        ...
        private void ReloadProfilePreview()
        {
            ...
            if (_entManager.TryGetComponent<HumanoidAppearanceComponent>(PreviewDummy, out var humanoid))
            {
                ...
                appearanceSystem.LoadProfile(PreviewDummy, Profile, humanoid, false, false, SponsorSimpleManager.GetTier());    //LP edit
        ...
        {
            Profile = HumanoidCharacterProfile.Random(sponsorTier: SponsorSimpleManager.GetTier());
